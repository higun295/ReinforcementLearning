...
class Model(tf.keras.Model):
    def __init__(self, num_actions, hidden):
        ...
        self.d1 = kl.Dense(512, kernel_initializer=VarianceScaling(scale=2.), activation='relu', name="d1")
        self.d2 = kl.Dense(256, kernel_initializer=VarianceScaling(scale=2.), activation='relu', name="d2")
